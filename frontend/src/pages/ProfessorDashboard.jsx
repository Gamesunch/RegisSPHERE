        ...
        const fetchDashboardData = async () => {
            try {
                ...
                const [coursesRes, announcementsRes] = await Promise.all([
                    fetch(`${API_BASE_URL}/api/courses/professor`, { headers: { 'Authorization': `Bearer ${token}` } }),
                    fetch(`${API_BASE_URL}/api/announcements/professor`, { headers: { 'Authorization': `Bearer ${token}` } })
                ]);
